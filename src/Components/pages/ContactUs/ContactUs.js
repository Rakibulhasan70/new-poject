  ...
  return (
    <div>
      <section className="max-w-7xl lg:mx-auto md:mx-5 mx-5">
        <div className="my-12">
          <h1 className="text-[#131313] lg:text-4xl md:text-3xl text-2xl font-bold text-center">
            CONTACT USS
          </h1>
          ...
          <div className="flex justify-center w-full">
            <p className="text-base text-[#848484] text-center lg:w-1/2 md:w-3/4 w-full">
        ...
        <div className="lg:flex md:flex grid grid-cols-1 items-center mb-12">
          ...
          <div className="lg:w-[40%] md:w-[40%] w-full lg:py-12 md:py-8 py-12 bg-[#0E0A31] lg:rounded-md md:rounded-md rounded-none">
            <h2 className="text-xl text-center font-bold text-[#fff] tracking-wider border-b-[2px] border-b-[#43BAFF] pb-2">
              SOFTONIXT
            </h2>
            <div className="lg:px-8 md:px-4 px-8">
              <div className="flex lg:gap-8 md:gap-4 gap-6 items-center border-b-[1px] border-b-[#737373] py-3">
                ...
                <p className="text-[#fff]">
                  Current We are working in Remotely.
                </p>
              </div>
              <div className="flex lg:gap-8 md:gap-4 gap-6 items-center border-b-[1px] border-b-[#737373] py-3">
                ...
                <div className="text-[#fff]">
                  <p>+880-1571142002</p>
                  <p>niharmonirulislam@gmail.com</p>
                </div>
              </div>
          ...
          <div className="lg:w-[30%] md:w-[30%] w-full py-28 lg:px-0 md:px-2 px-0 bg-[#43BAFF] lg:rounded-r-md md:rounded-r-md rounded-r-none">
            <p className="text-white text-xl text-center">
              <span className="text-[#fff] text-bold">24/7</span> Real Time
              Support
            </p>
          </div>
        </div>
      ...
      <section className="max-w-7xl lg:mx-auto md:mx-5 mx-5 py-12">
        <h1 className="text-[#131313] lg:text-4xl md:text-3xl text-2xl font-bold lg:ml-8 md:ml-8 ml-0 lg:text-start md:text-start text-center">
          GET IN TOUCH
        </h1>
        ...
        <div className="lg:flex md:flex grid grid-cols-1 lg:gap-12 md:gap-6 gap-12 pt-5">
            ...
            <form className="flex flex-col gap-3">
              <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-3">
                <input
                  ...
                  className="border-[1px] border-[#43BAFF] focus:border-[#7141B1] outline-none focus:outline-none p-4 w-full rounded-md"
                  required
                />
                <input
                  id="email"
              ...
              <PhoneInput country="bd" enableSearch="true" />
              <select
                className="text-[#848484] focus:border-[#7141B1] border-[1px] border-[#43BAFF] outline-none focus:outline-none p-4 w-full rounded-md"
                required
              >
          ...
          <div className="lg:w-2/5 md:w-2/5 w-full order-first md:order-last">
            ...
            <p className="lg:w-3/4 md:w-full w-full mt-5">
              Ready to know how we can help youu?
            </p>
            <div className="mt-5">
              <p className="text-xl font-bold">niharmonirulislam@gmail.com</p>
              <p className="text-xl font-bold">+880-1571142002</p>
            </div>
          </div>
        </div>
      </section>
      <div className="max-w-7xl lg:mx-auto md:mx-auto mx-5"></div>
    </div>
  );
};
