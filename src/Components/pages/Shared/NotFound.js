    ...
    return (
        <div className='flex justify-center'>
            <div className="not-found-content">
                ...
                <div className="not-found-head">page not found</div>
                <div className="description text-center">But dont worry, you can find plenty of other things on our homepage.</div>
