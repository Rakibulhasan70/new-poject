          ...
          <div className="max-w-7xl lg:mx-auto md:mx-auto mx-5 pt-20">
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-20 md:gap-20 gap-5 pb-12 FooterListBorder2">
              <div className="grid grid-cols-1 gap-8">
                ...
                <p className="text-base text-[#E3E6EA]">
                  Softonix is a leading provider of technology solutions and
                  services.
                </p>
                <div className="grid grid-cols-1 gap-2">
                  <p className="bg-[#322B5D] px-5 py-4 flex items-center gap-3 text-[#F6FAFF] text-sm font-semibold rounded-md w-64">
                    <img src={CallIconYellow} alt="" />
                    +880-1571142002
                  </p>
                  <p className="bg-[#322B5D] px-5 py-4 flex items-center gap-3 text-[#F6FAFF] text-sm font-semibold rounded-md w-64">
                    <img src={EmailIconYellow} alt="" />
                    niharmonirulislam@gmail.com
                  </p>
                  <p className="bg-[#322B5D] px-5 py-4 flex items-center gap-3 text-[#F6FAFF] text-sm font-semibold rounded-md w-64">
                    <img src={LocationIconYellow} alt="" />
                    Currently we are working at Remotely
                  </p>
                </div>
              </div>
              <div>
                <p className="FooterListBorder text-2xl text-white font-bold pb-2">
                  Our Work
                </p>
                <div className="py-5 grid grid-cols-1 gap-3">
                  <Link
                    to="/aboutUs"
                    className="text-base font-semibold text-[#E3E6EA]"
                  >
                    About Us
                  </Link>
                  <Link
            ...
            <div className="lg:flex md:flex grid grid-cols-1 justify-between items-center py-6">
              <div>
                <p className="text-[#E3E6EA] text-base">
                  © 2022 Copyrights by{" "}
                  <span className="text-[#F74F22] font-semibold">
                    Softonixt Technologies.
                  </span>{" "}
                  All Rights Reserved.
                </p>
              </div>
              <div className="flex items-center justify-center gap-4">
                <Link to="">
                  <img
                    src={FacebookLogo}
                    alt="Facebook logo"
                    className="bg-[#322B5D] rounded-md px-4 py-4"
                  />
                </Link>
                <Link to="">
                  <img
